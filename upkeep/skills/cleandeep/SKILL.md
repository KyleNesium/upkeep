...
Self-update is checked by the main `/upkeep:upkeep` entrypoint. Direct invocations of `/upkeep:cleandeep` skip the check — re-enter via `/upkeep` once a day if you want the nudge.
